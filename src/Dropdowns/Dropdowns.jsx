    ...
    <>
      ...
      <div className="comp-button-container-div">
        ...
        <div className="comp-text-body">
          <p>
            Drop-down menus, also known as drop-down lists or select menus, are
            a common element in design,
            <br /> they are used as a means of allowing users to select an
            option from a list of choices.
            <br /> They are often used in forms, settings, and other interfaces
            where users need to select one item from a list of options.
          </p>

          <p>
            Designing effective drop-down menus can greatly improve the user
            experience and make it more intuitive and efficient.
          </p>

          <p>
            They should be consistent, clear, accessible, provide feedback,
            <br /> use the right size, grouped together with similar options,
            placed near the item they correspond to,
            <br /> and show the default or selected option.
          </p>
        </div>
        ...
        <div className="input-field-container">
          <div className="comp-text-body">
            ...
            <p>
              A dropdown presents a menu of actions or links in a constrained
              space that will trigger a process or navigate to a new location.
              <br />
              Standard dropdowns present users with a menu of items upon
              clicking a dropdown toggle or button.{" "}
            </p>
          </div>
