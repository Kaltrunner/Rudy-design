    ...
    <>
      ...
      <div className="comp-button-container-div">
        ...
        <div className="comp-text-body">
          <p>
            Search Bars are a common element in design, they are used as a means
            of allowing users to search for content or information within a
            website or app.
            <br /> They are often located in the header or navigation of a
            website or app and can be used to search for products, articles, or
            other types of content.
          </p>

          <p>
            Designing effective search bars can greatly improve the user
            experience and make it more intuitive and efficient.
          </p>

          <p>
            A well-designed search bar can greatly improve the user experience
            by making it more intuitive and efficient.
            <br /> They should be prominently placed, clear, accessible, provide
            feedback, use the right size,
            <br /> show search suggestions, allow for advanced search options,
            test and optimize and make it easy to clear.
          </p>
        </div>
        ...
        <div className="search-field-container">
          <div className="comp-text-body">
            ...
            <p>
              The search bars are designed to be simple and minimalistic in
              order to make them easy to use and understand.
            </p>

            <p>
              <strong>Text input field:</strong> This is where the user enters
              their search query.
              <br />
              <strong>Search button or icon:</strong> This initiates the search
              and sends the query to the search engine or database.
            </p>
          </div>
        ...
        <div className="search-field-container">
          <div className="comp-text-body">
            <h2>Search Input Field</h2>
            <p>
              This search bar is very minimalistic and without a button, when
              useing this search bar queries will automaticly populate a search
              field.
            </p>
          </div>
          <div className="search-field-div">
          ...
          {searchCodeAlong ? (
            <div className="code-along-div">
              <button className="css-button">HTML</button>
              <button
                onClick={() => setSearchCodeAlong(false)}
                className="html-button"
              >
                CSS
              </button>
            ...
            <div className="code-along-css-div">
              <button
                onClick={() => setSearchCodeAlong(true)}
