    ...
    <>
      ...
      <div className="comp-button-container-div">
        ...
        <div className="comp-text-body">
          <p>
            Checkboxes are a common element in design, they are used as a means
            of allowing users to make multiple selections from a list of
            options.
            <br /> They are often used in forms, settings, and other interfaces
            where users need to select one or more items from a list.
          </p>

          <p>
            Designing effective checkboxes can greatly improve the user
            experience and make it more intuitive and efficient.{" "}
          </p>

          <p>
            They should be consistent, clear, accessible, provide feedback, use
            the right size, grouped together with similar options and placed
            near the item they correspond to.
          </p>
        </div>
        ...
        <div className="input-field-container">
          <div className="comp-text-body">
            ...
            <p>
              This checkbox is used to select a single item or multiple items,
              typically to choose elements to perform an action.
            </p>
          </div>
          ...
          <div className="comp-text-body">
            ...
            <p>
              This checkbox is used to select a single item or multiple items,
              typically to delete or exclude elements from performing an action.
            </p>
          </div>
          <div className="checkbox-field-div">
            <h4 className="checkbox-field-h4">Standard checkbox examples</h4>
          ...
          <div className="comp-text-body">
            ...
            <p>
              To indicate that an action is currently unavailable, all checkbox
              variations can be seen in thier Disabled state.
            </p>
          </div>
          <div className="checkbox-field-div">
            <h4 className="checkbox-field-h4">
              Standard and Radio disabled checkbox examples
            </h4>

            <div className="button-example-div">
              <label class="dis-container">
                One
                <input type="checkbox" checked="checked" />
              ...
              <label class="dis-container-radio">
                Three
                <input type="checkbox" checked="checked" />
