    ...
    <>
      ...
      <div className="comp-button-container-div">
        ...
        <div className="comp-text-body">
          <p>
            Toggles, also known as toggle buttons or switch controls, are a
            common element in design.
            <br /> They are used as a means of allowing users to switch between
            two or more states, such as on and off, true and false, or multiple
            options.
            <br /> They are often used in forms, settings, and other interfaces
            where users need to enable or disable certain features or options.
          </p>

          <p>
            Designing effective toggles can greatly improve the user experience
        ...
        <div className="input-field-container">
          <div className="comp-text-body">
            ...
            <p>
              Toggles can be useful in situations where the user needs to
              quickly enable
              <br /> or disable a feature or setting and it is important to give
              the user a clear and simple way of doing that.
            </p>

            <p>
              Toggles can be implemented in a variety of ways, they can be
              represented visually as on/off buttons, or as a sliding control.{" "}
              <br />
              They allow users to switch between two or more states. They are
              often used to enable or disable specific features or settings
              within an interface.
            </p>
          </div>
        ...
        <div className="input-field-container">
          <div className="comp-text-body">
            ...
            <p>
              This toggle variant acts the same at the primary, the only
              difference is that the border and switch have a border-radius of
              25px.
            </p>
          </div>
        ...
        <div className="input-field-container">
          <div className="comp-text-body">
            ...
            <p>
              This toggle variant has a right side resting state, or "OFF"
              possition.
              <br /> These toggles have the same attributes as the primary &
              rounded.
            </p>
          </div>
        ...
        <div className="input-field-container">
          <div className="comp-text-body">
            ...
            <p>
              To indicate that an action is currently unavailable, all toggles
